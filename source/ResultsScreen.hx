...
class ResultsScreen extends FlxSubState
{
	...
	{	
        ...
        text = new FlxText(20,-55,0,"Musique terminée!");
        text.size = 34;
        ...
        if (PlayState.isStoryMode)
        {
            ...
            text.text = "Semaine términée!";
        }

        comboText = new FlxText(20,-75,0,'Jugements:\nParfait - ${PlayState.sicks}\nBons - ${PlayState.goods}\nMauvais - ${PlayState.bads}\n\nCombo Brisés: ${(PlayState.isStoryMode ? PlayState.campaignMisses : PlayState.misses) + PlayState.shits}\nCombo le plus haut: ${PlayState.highestCombo + 1}\n\nScore: ${PlayState.instance.songScore}\nPrécision: ${HelperFunctions.truncateFloat(PlayState.instance.accuracy,2)}%\n\n${Ratings.GenerateLetterRank(PlayState.instance.accuracy)}\n\nF1 - Regarder le Replay\nF2 - Rejouer le niveau
        ');
        comboText.size = 28;
        ...
        contText = new FlxText(FlxG.width - 475,FlxG.height + 50,0,'Appuyez sur ENTREE pour continuer.');
        contText.size = 28;
        ...
        settingsText = new FlxText(20,FlxG.height + 50,0,'SF: ${PlayState.rep.replay.sf} | Ratio (SA/GA): ${Math.round(sicks)}:1 ${Math.round(goods)}:1 | Mean: ${mean}ms | Joué sur ${PlayState.SONG.song} ${CoolUtil.difficultyString()}');
